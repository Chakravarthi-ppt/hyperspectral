...
//            case FusionRule::MajorityOfTwo: result = samSaysBuiltUp && svmSaysBuiltUp; break; // 2-vote majority == AND
...
//    Logger::log("BuiltUpClassifier", "SAM/SVM fusion complete. Classifier agreement: " +
//                std::to_string(100.0 * agreeCount / cube.pixelCount()) + "%.");
