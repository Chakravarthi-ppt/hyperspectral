...
//        }
//        try {
//            RasterCube changeMap = ChangeDetector::computeChangeMap(*mw_->appState().lulcSupervisedA,
//                                                                      *mw_->appState().lulcSupervisedB);
//            mw_->previewWidget()->showSingleBand(changeMap, 0);
...
//    }
//    try {
//        lastResult_ = ChangeDetector::computeChangeMatrix(*mw_->appState().lulcSupervisedA,
//                                                            *mw_->appState().lulcSupervisedB,
//                                                            pixelAreaSpin_->value());
//        hasResult_ = true;
...
//        QStringList headers;
//        headers << "from \\ to";
//        for (int id : lastResult_.classIds) headers << QString("class %1").arg(id);
//        table_->setHorizontalHeaderLabels(headers);

//        long totalPixels = 0, changedPixels = 0;
//        for (int i = 0; i < n; ++i) {
//            table_->setItem(i, 0, new QTableWidgetItem(QString("class %1").arg(lastResult_.classIds[i])));
//            for (int j = 0; j < n; ++j) {
