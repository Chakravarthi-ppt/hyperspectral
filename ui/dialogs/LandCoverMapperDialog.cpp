...
//// ─── Constructor ─────────────────────────────────────────────────────────
//LandCoverMapperDialog::LandCoverMapperDialog(MainWindow* mw, QWidget* parent)
...
//// ─── Slot helpers ─────────────────────────────────────────────────────────
//static const RasterCube* requireCube(MainWindow* mw) {
...
//        if (c >= 0 && c <= 6) ++cnt[c];
//    }
//    long total = static_cast<long>(result.pixelCount());
//    auto pct   = [&](int c) { return total ? 100.0 * cnt[c] / total : 0.0; };

//    QString summary =
//        QString("Results (%1 × %2 pixels):\n\n"
//                "Built-up    : %3  (%4%)\n"
//                "Forest      : %5  (%6%)\n"
//                "Vegetation  : %7  (%8%)\n"
//                "Water/River : %9  (%10%)\n"
...
//            .arg(cnt[0]).arg(pct(0), 0, 'f', 1);

//    QMessageBox::information(this, "Land cover classification complete", summary);
//    mw_->log("LandCoverMapper", QString("Done. Built-up=%1 Forest=%2 Water=%3 Veg=%4 Soil=%5 Unclassified=%6")
//                 .arg(cnt[1]).arg(cnt[2]).arg(cnt[4]).arg(cnt[3]).arg(cnt[5]).arg(cnt[0]));
//}
