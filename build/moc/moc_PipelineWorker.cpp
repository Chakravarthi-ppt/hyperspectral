/****************************************************************************
** Meta object code from reading C++ file 'PipelineWorker.h'
**
...
#include <memory>
#include "../../ui/PipelineWorker.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'PipelineWorker.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(7, 58, 12) // "errorMessage"

    },
    "PipelineWorker\0progress\0\0percent\0"
    "message\0finished\0success\0errorMessage"
};
...
void PipelineWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PipelineWorker::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PipelineWorker::progress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PipelineWorker::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PipelineWorker::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PipelineWorker::progress(int _t1, QString _t2)
{
...
// SIGNAL 1
void PipelineWorker::finished(bool _t1, QString _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
