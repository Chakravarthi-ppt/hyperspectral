...
//////StepWidget MainWindow::makeStep(int num, const QString& title, const QString& tooltip) {
//////    StepWidget sw;
...
//////    // Wire step buttons
//////    connect(steps_[0].btn, &QPushButton::clicked, this, &MainWindow::onStep1_LoadOrtho);
//////    connect(steps_[1].btn, &QPushButton::clicked, this, &MainWindow::onStep2_Preprocess);
//////    connect(steps_[2].btn, &QPushButton::clicked, this, &MainWindow::onStep3_SurfaceObjectMask);
//////    connect(steps_[3].btn, &QPushButton::clicked, this, &MainWindow::onStep5b_LandCoverMapper);
//////    connect(steps_[4].btn, &QPushButton::clicked, this, &MainWindow::onStep4_PcaAndStack);
//////    connect(steps_[5].btn, &QPushButton::clicked, this, &MainWindow::onStep5_BuiltUp);
//////    connect(steps_[6].btn, &QPushButton::clicked, this, &MainWindow::onStep6_RasterToVector);
//////    connect(steps_[7].btn, &QPushButton::clicked, this, &MainWindow::onStep7_Lulc);
//////    connect(steps_[8].btn, &QPushButton::clicked, this, &MainWindow::onStep8_ChangeDetection);
...
//////    hsMenu->addAction("1. Load + Orthorectify…",         this, &MainWindow::onStep1_LoadOrtho);
//////    hsMenu->addAction("2. DN → Surface Reflectance…",    this, &MainWindow::onStep2_Preprocess);
//////    hsMenu->addAction("3. Surface / Object Mask…",       this, &MainWindow::onStep3_SurfaceObjectMask);
//////    hsMenu->addAction("4. Land Cover Map (Forest/Water/Built-up)…", this, &MainWindow::onStep5b_LandCoverMapper);
//////    hsMenu->addAction("5. PCA + Stack…",        this, &MainWindow::onStep4_PcaAndStack);
//////    hsMenu->addAction("6. Built-up (SAM + SVM → 1 band)…", this, &MainWindow::onStep5_BuiltUp);
//////    hsMenu->addAction("7. Raster → Vector…",             this, &MainWindow::onStep6_RasterToVector);
//////    hsMenu->addAction("8. LULC Classification…",         this, &MainWindow::onStep7_Lulc);
//////    hsMenu->addAction("9. Change Detection Matrix…",     this, &MainWindow::onStep8_ChangeDetection);
//////    hsMenu->addSeparator();
//////    hsMenu->addAction("▶  Run Full Pipeline",            this, &MainWindow::onRunAll);
//////    hsMenu->addSeparator();
//////    auto* toolsMenu = menuBar()->addMenu("&Tools");
//////    toolsMenu->addAction("Anomaly Detector (RX)…", this, &MainWindow::onToolAnomalyDetector);
//////    menuBar()->addSeparator();
//////    hsMenu->addAction("About…",                          this, &MainWindow::onAbout);
//////}

//////// ── step status refresh ───────────────────────────────────────────────────
//////void MainWindow::refreshStepStatus() {
...
//////// ── logging ───────────────────────────────────────────────────────────────
//////void MainWindow::log(const QString& stage, const QString& message) {
...
//////void MainWindow::onStep1_LoadOrtho() {
//////    // Default to ~/Documents/Hyperspectral_Data/ where previously merged
//////    // stacks are saved — so users can load the .tif directly next time
//////    // instead of re-selecting the original zip.
//////    QString defaultDir;
//////    {
...
//////void MainWindow::onStep2_Preprocess() {
...
//////            previewWidget()->showRgb(*state_.surfaceReflectance, 20, 12, 3);
//////            log("Preview", "Showing false-colour RGB (R=660nm / G=549nm / B=467nm).");
//////        }
//////    }
//////}

//////// ── Step 3 — Surface / Object Mask ───────────────────────────────────────
//////void MainWindow::onStep3_SurfaceObjectMask() {
...
//////void MainWindow::onStep5b_LandCoverMapper() {
...
//////void MainWindow::onStep4_PcaAndStack() {
//////    PcaStackDialog dlg(this, this);
//////    if (dlg.exec() == QDialog::Accepted) {
//////        refreshStepStatus();
//////        if (state_.stackFused && state_.stackFused->bands >= 21) {
//////            previewWidget()->showRgb(*state_.stackFused, 20, 12, 3);
//////            log("Preview", QString("Stack: %1 bands total. Showing Hyperion RGB false-colour.")
...
//////void MainWindow::onStep5_BuiltUp() {
...
//////void MainWindow::onStep6_RasterToVector() {
//////    if (!state_.builtUpMask) {
//////        QMessageBox::warning(this, "Step 5 first", "Run Built-up Classification (Step 5) before exporting to vector.");
//////        return;
//////    }
//////    QString path = QFileDialog::getSaveFileName(this, "Save built-up vector",
...
//////    try {
//////        hsi::RasterToVector::polygonize(*state_.builtUpMask, path.toStdString(), driver.toStdString());
//////        log("RasterToVector", QString("Built-up vector exported → %1").arg(path));
//////        QMessageBox::information(this, "Export complete",
//////            QString("Built-up polygons written to:\n%1").arg(path));
//////        refreshStepStatus();
//////    } catch (const std::exception& e) {
...
//////void MainWindow::onToolAnomalyDetector() {
